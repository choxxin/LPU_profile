...
function Login() {
  ...
  const { setRegistrationNumber, setPass, setCook, setName, setdp, name } =
    useUserStore();
  ...
  const handleLogin = async (e) => {
    ...
    try {
      setloading(true);
      const loginData = await loginUser(username, password, Inputs.avatar);
